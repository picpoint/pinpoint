...
/**
 * Перебирает все поля скрытого div-a для вставки данных
 * и дальнейшего добавления метки на карту и показа на карте пользователя
 */
...
/**
 * Перебирает все поля скрытого расшаренного div-a для вставки данных
 * и дальнейшего добавления метки на карту и показа на карте пользователя
 * Данный div используется для меток которые были репостнуты друзьями для
 * текущего пользователя
 *
 * В данном цикле есть стилизация меток отличная
 * от стилизации классической пользовательской метки
 */
